---
date: 2021-02-04 11:52:32

title: 【Activiti】Java工作流引擎 Activiti 万字详细入门
---
...
![img](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/6d5fa212cb5c4186af366a6af2359a80.png)

经历的版本:

![img](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/b2b6a0483819682db174c2d0bcaacd31.png)
...
![img](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/4a5c9b0e87bab71979a722ea5967d1df.png)
...
![img](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/c62d43f73620718b749276dd6e9c8c53.png)

活动用圆角矩形表示，一个流程由一个活动或多个活动组成

![img](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/2e9e2be515de8ff8a0cdd4e238bc35d0.png)
...
![img](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/4222667fb5d6374e5d494385bcbf04b4.png)

此时我们就可以搜索到actiBPM插件，它就是Activiti Designer的IDEA版本，我们点击Install安装。

安装好后，页面如下：

![img](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/f5a2177202ea9dd4630e255c403d7100.png)

提示需要重启idea，点击重启。

重启完成后，再次打开Settings 下的 Plugins（插件列表），点击右侧的Installed（已安装的插件），在列表中看到actiBPM，就说明已经安装成功了，如下图所示：

![img](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/988e0af68496e1b4d219c78685ab7f2c.png)
...
![img](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/303798960a34b13286c1078b3cdbba1b.png)

执行完成后我们查看数据库， 创建了 25 张表，结果如下：

![img](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/abf223e14cf32150f025c12b84be2eab.png)
...
![img](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/eb571b5c4a1dff4f54dd504a537e4ade.png)
...
![1574522151044](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/55da0d46ad4664bec6f38a53aec9e98f.png)

### 活动 Activity

活动是工作或任务的一个通用术语。一个活动可以是一个任务，还可以是一个当前流程的子处理流程； 其次，你还可以为活动指定不同的类型。常见活动如下：

![1574562726375](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/fa7d32728f189f729285e260a68c966b.png)

### 网关 GateWay

网关用来处理决策，有几种常用网关需要了解：

![1574563600305](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/4e671fa1ca691aae89fcba2f6cd9c7f4.png)
...
### 流向 [Flow](https://so.csdn.net/so/search?q=Flow&spm=1001.2101.3001.7020)

流是连接两个流程节点的连线。常见的流向包含以下几种：

![1574563937457](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/3628cf5044d11d8aa723d8d62de112a9.png)
...
![1575106985823](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/a29cab07f2cdeeecf23a121b955f1f38.png)

弹出如下图所示框，输入evection 表示 出差审批流程：

![1575107231004](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/b73038594eb6a617ab01d06ecd67d71f.png)

起完名字evection后（默认扩展名为bpmn），就可以看到流程设计页面，如图所示：

![1575107336431](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/5e11bd3ce21ca2170f3aab1954de69af.png)
...
![1575107648105](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/1938218ad58d78c29863e3c3cbaf13ac.png)

### 指定流程定义Key

流程定义key即流程定义的标识，通过properties视图查看流程的key

![1575115474865](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/80e8ed41d420a613bb3601866bccc0b3.png)

### 指定任务负责人

在properties视图指定每个任务结点的负责人，如：填写出差申请的负责人为 zhangsan

![1575121491752](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/f5c59207b9f63ed98c0b14b07c35e172.png)
...
![1575108966935](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/68e0b7ef038641fe75c8b4789bc9fd82.png)

evection.xml修改前的bpmn文件，效果如下：
![在这里插入图片描述](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/20210624233410152.png)

#### 2、使用designer设计器打开.xml文件

在evection.xml文件上面，点右键并选择Diagrams菜单，再选择Show BPMN2.0 Designer…

![1575109268443](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/56cf4c6dbe90593db85bff1b5c0b10dc.png)

#### 3、查看打开的文件

打开后，却出现乱码，如图：

![1575109366989](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/98adf795b3a3c57761fc49084a28af51.png)

#### 4、解决中文乱码

1、打开Settings，找到File Encodings，把encoding的选项都选择UTF-8

![1575112075626](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/223fbee930641ac8f6d65a467a5d36c2.png)

2、打开IDEA安装路径，找到如下的安装目录

![1575109627745](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/4a5e3f122c63db4551f7e675fd36fa4e.png)

根据自己所安装的版本来决定，我使用的是64位的idea，所以在idea64.exe.vmoptions文件的最后一行追加一条命令： -Dfile.encoding=UTF-8

如下所示：

![https://images2017.cnblogs.com/blog/963440/201712/963440-20171221132445475-1259807908.png](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/b393629505f3409a3aca9578840b8606.png)

一定注意，不要有空格，否则重启IDEA时会打不开，然后 重启IDEA。

如果以上方法已经做完，还出现乱码，就再修改一个文件，并在文件的末尾添加： -Dfile.encoding=UTF-8，然后重启idea，如图：

![1575113551947](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/ff19450a5625b5ae625128507546bb3c.png)

最后重新在evection.xml文件上面，点右键并选择Diagrams菜单，再选择Show BPMN2.0 Designer…，看到生成图片，如图：

![1575113951966](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/5b284f4d81d5207b8ea7e857f2f58ba1.png)
...
![1575114245068](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/31410de865cf7a691087db4009d0fcd2.png)
...
![1575116732147](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/bcf465a3c35a6e66e2ca075a0f793dd1.png)
...
![1575116797665](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/f84eb1d97f90541675bd5a538b51d381.png)
...
![在这里插入图片描述](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/20210624233344315.png)
...
![1575117588624](https://brath4.oss-cn-shenzhen.aliyuncs.com/picgo/1638a3cecc5fbee4dc99ceb37e4647dd.png)
...
- 基本功能介绍以及完成了，如果还需要更加高级的功能比如挂起、激活流程实例、流程变量等请参考[【https://andyoung.blog.csdn.net/article/details/118345330】](https://andyoung.blog.csdn.net/article/details/118345330)。
- 工作流引擎 Activiti 与 Spring boot 结合会是开发跟简单，不如来看下 [【工作流引擎 Activiti 实战系列】](https://andyoung.blog.csdn.net/article/details/118372175)
