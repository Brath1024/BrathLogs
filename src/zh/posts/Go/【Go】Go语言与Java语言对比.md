...
他有三种状态：
 ...
 第三个是auto自动检测状态，在此状态下会判断项目是否在G O P A T H / s r c 外，如果在外面，会判断项目根目录下是否有 g o . m o d 文件，如果均有则开启 M o d u l e 功能，如果缺任何一个则会从 {GOPATH}/src外，如果在外面，会判断项目根目录下是否有go.mod文件，如果均有则开启Module功能，如果缺任何一个则会从*GOP**A**T**H*/*src*外，如果在外面，会判断项目根目录下是否有*g**o*.*m**o**d*文件，如果均有则开启*M**o**d**u**l**e*功能，如果缺任何一个则会从{GOPATH}下寻找依赖包。
