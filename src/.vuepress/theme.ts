...
export default hopeTheme({
  ...
  blog: {
    name: 'Brath',
    description: '为了更好的你，也为了更好的世界',
    intro: 'https://brath.top',
    roundAvatar: true,
    timeline: '往期回顾',
    articlePerPage: 5,
    medias: {
      // '泠灵(特别鸣谢)': ['https://schokolade.com', MR_HOPE_AVATAR],
      // '荔知(chatGPT)': ['https://www.brath.cn', MR_HOPE_AVATAR],
      // '面试记Github': ['https://github.com/Guoqing815/interview', MR_HOPE_AVATAR],
      // '面试记App(Android)': ['https://www.pgyer.com/interview_app_release', MR_HOPE_AVATAR],
      // 'Gitee(码云)': ['https://gitee.com/Guoqing-Li', MR_HOPE_AVATAR],
      // 'CSDN': ['https://blog.csdn.net/Brath?type=blog', MR_HOPE_AVATAR],
      // '掘金': ['https://juejin.cn/user/settings/profile', MR_HOPE_AVATAR],
      // 'AliCloud(阿里云)': ['https://oss.console.aliyun.com', MR_HOPE_AVATAR],
      // 'TencentCloud(腾讯云)': ['https://cloud.tencent.com', MR_HOPE_AVATAR],
      // 'BOSS(招聘)': ['https://www.zhipin.com/web/user', MR_HOPE_AVATAR],
      // 'Bilibili(B站)': ['https://www.bilibili.com', MR_HOPE_AVATAR],
      'Zhihu': "https://www.zhihu.com/people/yi-sheng-bie-chi-xiao-58",
      'Brath(Github)': ['https://github.com/Guoqing815', MR_HOPE_AVATAR],
    },
  },
  ...
  locales: {
    "/": {
      ...
      blog: {
        description: "An arbitrary developer",
        intro: "/intro.html",
      },

      metaLocales: {
        origin: 'Brath的博文并非全部原创，如果您发现有侵权行为，可以联系Brath邮箱删除文章：brath.stack@Gmail.com',
